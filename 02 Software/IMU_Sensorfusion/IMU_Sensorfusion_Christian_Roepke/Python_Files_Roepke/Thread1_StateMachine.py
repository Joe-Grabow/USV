...
class Thread1_StateMachine:
    ...
    from calibrating_routine_ak8963 import check_cal_data, calibration_routine_ak8963
...
#         print(self.state)
        ...
        if self.state == 0:
            ...
            # debug to state 8
            self.state = 8
#             if Thread1_StateMachine.check_cal_data('cal_data.json'):
#                 self.state = 2
#             else:
#                 self.state = 3
        elif self.state == 2:
